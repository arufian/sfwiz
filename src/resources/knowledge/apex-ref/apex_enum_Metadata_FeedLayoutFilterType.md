...
FeedLayoutFilterType Enum The type of feed layout filter. Enum Values The following are the values of the Metadata.FeedLayoutFilterType enum. Value | Description  
---|---  
