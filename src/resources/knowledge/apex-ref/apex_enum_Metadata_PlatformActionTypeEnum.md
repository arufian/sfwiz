...
PlatformActionTypeEnum Enum The type of action for a PlatformActionListItem. Enum Values The following are the values of the Metadata.PlatformActionTypeEnum enum. Value | Description  
---|---  
