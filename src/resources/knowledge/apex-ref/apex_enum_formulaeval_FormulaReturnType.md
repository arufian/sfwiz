...
FormulaReturnType Enum Specifies the return type for the withReturnType(returnType) method. Enum Values The following are the values of the FormulaEval.FormulaReturnType enum. Value | Description  
---|---  
