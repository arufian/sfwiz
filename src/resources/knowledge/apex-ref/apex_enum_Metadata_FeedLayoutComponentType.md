...
FeedLayoutComponentType Enum Indicates the type of feed layout component. Enum Values The following are the values of the Metadata.FeedLayoutComponentType enum. Value | Description  
---|---  
